...
sender = 'linhaoran_kindle@163.com'  # 设置发件邮箱，一定要自己注册的邮箱
pwd = '10131201'  # 设置发件邮箱的密码，等会登陆会用到
receiver = 'linhaoran_smzdm@163.com'  # 设置邮件接收人，这里是我的公司邮箱

cc = [
    # 'haoran.lin@icbc.com.cn',
    # 'linhaoran@163.com'
]
...
# msg['cc'] = ",".join(cc)
msg['subject', 'from', 'to', 'cc'] = ['Helloworld", sender, receiver, ','.join(cc)']
